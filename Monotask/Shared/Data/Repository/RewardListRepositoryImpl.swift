    ...
    func fetchRewards() -> [RewardModel] {
        do {
            ...
            let firstReward = RewardLocalEntity(id: "Stage1",
                                                rewardNumber: 1,
                                                rewardName: "The Hope",
                                                rewardDescription: String(localized: "Patience and care in fostering new beginnings."),
                                                rewardMessage: String(localized: "Keep this momentum going! Remember, every step forward is a win, no matter how small."),
            ...
            let secondReward = RewardLocalEntity(id: "Stage2",
                                                 ...
                                                 rewardDescription: String(localized: "Golden flowers, now in full bloom, illuminated the path ahead."),
                                                 rewardMessage: String(localized: "Completing tasks isn't always easy and now it's time to celebrate your success"),
            ...
            let thirdReward = RewardLocalEntity(id: "Stage3",
                                                rewardNumber: 3,
                                                rewardName: "The Star",
                                                rewardDescription: String(localized: "Amidst the challenges, a star is preserved as something pure."),
                                                rewardMessage: String(localized: "Completing tasks can be a real challenge, but you powered through and made it happen."),
